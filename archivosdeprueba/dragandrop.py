...
class Window(QWidget):
    def __init__(self):
        ...
        QListWidgetItem(QIcon('sprites\mapa\mapa_sin_borde_2.png'), "HTLM", self.
                        myListWidget2)
        QListWidgetItem(QIcon('sprites\mapa\mapa_1_parte_03.png'), "CSS", self.
                        myListWidget2)
        QListWidgetItem(QIcon('sprites\mapa\accesorios\spritesheet.png'), "Javascript", self.
                        myListWidget2)
